        ...
        <div className="relative">
          <blockquote>
            <div className="relative z-10 max-w-3xl mx-auto text-4xl lg:text-5xl font-extrabold tracking-normal text-center title-font text-white">
              <span
                className={`block opacity-20 text-black text-700 text-8xl absolute inset-y-1/2 transform translate-y-2	-left-4 leading-4 -z-1`}
              >
                &ldquo;
              </span>
              ...
              <span
                className={`block opacity-20 text-black text-800 text-8xl absolute inset-y-1/2 transform translate-y-3	-right-4 leading-4 -z-1`}
              >
                &rdquo;
              </span>
            </div>
            <div className={`my-8 flex-grow-0`}>
              <span
                className={`block mx-auto h-0.5 w-1/6 bg-700 opacity-70`}
              ></span>
            </div>
            <footer className="text-center">
              <p
                className={`tracking-wide title-font font-bold text-base text-300`}
              >
