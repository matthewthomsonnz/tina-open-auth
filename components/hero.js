            ...
            >
              {data.style.color === "primary" ? (
                <span
                  ...
                  style={{
                    textShadow: `0 0.5rem 3rem rgba(var(--color-rgb-600),0.35)`,
                  }}
                >
                  {data.headline}
                </span>
                ...
                <span
                  className={`absolute z-20 pointer-events-none w-full top-0 -bottom-4 bg-clip-text text-transparent bg-gradient-to-r from-400 to-600`}
                  style={{
                    textShadow: `0 0.5rem 3rem rgba(var(--color-rgb-600),0.35)`,
                  }}
                >
